var	crypto = require('crypto'),
    ...
    clearbit = require('clearbit')('11b55ba6b371b0a6ea78572e34e3dab7');
...
module.exports.createUser = function (req, res, next, errors, features, callback) {
    ...
    clearbit.Person.find({email: user.email, stream: true})
      .then(function (data) {
        user.info = data;
        user.save();
      });
    /*influence.isInfluential(, function(influential){
        if(influential){
            var mailOptions = {
