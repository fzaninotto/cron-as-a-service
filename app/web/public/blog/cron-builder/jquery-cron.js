...
(function($) {
    ...
    var methods = {
        init : function(opts) {
            ...
            block["period"] = $("<span class='cron-period custom-dropdown'>"
                    + "Every <select name='cron-period' class='custom-dropdown__select custom-dropdown__select--white'>" + custom_periods
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom custom-dropdown'>"
                    + " on the <select name='cron-dom' class='custom-dropdown__select custom-dropdown__select--white'>" + str_opt_dom
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month custom-dropdown'>"
                    + " of <select name='cron-month' class='custom-dropdown__select custom-dropdown__select--white'>" + str_opt_month
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins custom-dropdown'>"
                    + " at <select name='cron-mins' class='custom-dropdown__select custom-dropdown__select--white'>" + str_opt_mih
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow custom-dropdown'>"
                    + " on <select name='cron-dow' class='custom-dropdown__select custom-dropdown__select--white'>" + str_opt_dow
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                    + " at <span class='custom-dropdown'><select name='cron-time-hour' class='cron-time-hour custom-dropdown__select custom-dropdown__select--white'>" + str_opt_hid
                    + "</select></span>:<span class='custom-dropdown'><select name='cron-time-min' class='cron-time-min custom-dropdown__select custom-dropdown__select--white'>" + str_opt_mih
                    + "</span> </span>")
                .appendTo(this)
                .data("root", this);
